...
const projectsData: Record<string, any> = {
    ...
    'UNEXT DOOR': {
        ...
        sections: [
            { title: 'Mobile App', link: 'https://play.google.com/store/apps/details?id=com.UNextDoor.app&hl=en_IN', content: 'UnextDoor is an AI-powered language learning and practice platform where learners can build real conversational fluency through interactive AI chats, personalized feedback, vocabulary games, and adaptive learning paths — all designed to make language learning engaging, effective, and confidence-boosting.', image: '/mobile-black.png' },
